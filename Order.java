...
public class Order {
    ...
    /**
     * whether the customer is a member or not - to qualify for discount when paying later 
     */
...
/**
 * getter method that returns the staff object which represents the staff that took the order 
 * @return staff object 
 */
