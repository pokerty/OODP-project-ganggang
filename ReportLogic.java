 ...
 */
     ...
     */
    public void showSetPromo(Report report, Calendar cal){
    	Date dateandtime = cal.getTime();
     ...
     */
    public void showAlaCarte(Report report, Calendar cal){
    	Date dateandtime = cal.getTime();
     ...
     */
    public void showAll(Report report, Calendar cal){
        showSetPromo(report,cal);
        showAlaCarte(report,cal);
    }
